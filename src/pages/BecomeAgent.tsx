...
import { UserPlus, CheckCircle, Shield, TrendingUp, Building2, Loader2 } from "lucide-react";
...
const BecomeAgent = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitted(true);
      toast({ title: "🎉 Application Submitted!", description: "Our team will review your application within 48 hours." });
    } catch (err: any) {
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="pt-16 flex items-center justify-center min-h-[80vh]">
          <div className="max-w-md text-center p-8">
            ...
            <p className="text-muted-foreground mb-6">Your application to become a PropEstate agent has been submitted. Our admin team will review it within 48 hours. You'll receive an email with your login credentials once approved.</p>
      ...
      <div className="pt-16">
        ...
        <div className="max-w-2xl mx-auto px-4 py-12">
          <div className="bg-card rounded-2xl border border-border p-8 shadow-card">
            ...
            <p className="text-sm text-muted-foreground mb-6">Fill in your details. Admin will review and approve your profile.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button type="submit" disabled={loading || !user} className="w-full py-3 rounded-xl btn-gold font-semibold text-sm flex items-center justify-center gap-2 disabled:opacity-60">
